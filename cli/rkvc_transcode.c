...
static void usage(void)
{
    fprintf(stderr,
       ...
       "    编码  video → .mlvc :\n"
       "      -c mlvc -o out.mlvc --mlvc-enc models/mlvc/MLVCEncoder_rk3588.rknn\n"
       "        --mlvc-gaussian-pmf models/mlvc/gaussian.bin\n"
       "        --mlvc-bitest-pmf models/mlvc/bitest.bin [--mlvc-qp 21]\n"
       "        [--mlvc-qp-patch-dir models/mlvc/qp_patches]\n"
       "    解码  .mlvc → .yuv （原始 NV12，无再编码）:\n"
       "      -i in.mlvc -o out.yuv --mlvc-dec models/mlvc/MLVCDecoder_rk3588.rknn\n"
       "        --mlvc-gaussian-pmf models/mlvc/gaussian.bin\n"

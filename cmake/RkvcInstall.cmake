...
if(TARGET rkvc_backend_rga)
    install(TARGETS rkvc_backend_rga
        LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}/rkvc/backends
        COMPONENT backends)
endif()

if(TARGET rkvc_backend_rknn)
    install(TARGETS rkvc_backend_rknn
        LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}/rkvc/backends
        COMPONENT backends)
endif()
...
if(TARGET rkvc_backend_svt)
    install(TARGETS rkvc_backend_svt
        LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}/rkvc/backends
        COMPONENT backends)
endif()

if(TARGET rkvc_backend_ffmpeg)
    install(TARGETS rkvc_backend_ffmpeg
        LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}/rkvc/backends
        COMPONENT backends)
endif()

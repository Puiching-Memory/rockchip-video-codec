...
struct fsetup { const char *tag; int fc, fo, fp; };
...
static void test_plan_deterministic(void **st) {
    ...
    assert_string_equal(plan.steps[1].factory->id, "beta");
    assert_string_equal(plan.steps[2].factory->id, "gamma");
